...
//   CHAT_MESSAGE: (data) => {
//     // 在这里处理接收到的消息
//     const chatInput = document.querySelector('textarea.search-consult-textarea'); // 替换为实际的选择器
//     if (chatInput) {
...
//       // 添加短暂延迟再触发点击事件
//       setTimeout(() => {
//         const button = document.querySelector('button.send-arrow-button');
//         if (button) {
//           button.click(); // 点击发送按钮
//         }
//       }, 100); // 延迟100毫秒
...
//   NEW_CHAT: (data) => {
//     const button = document.querySelector('div.new-chat-and-temp-mode-trigger');
//     if (button) {
